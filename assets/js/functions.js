...
!function(window, doc, exportName, undefined) {
  ...
  function next(x) {
    ...
    $(".side-nav").children().eq(x).addClass("is-active");
    $(".outer-nav").children().eq(x).addClass("is-active");
    var nav_name = $(".side-nav").children().eq(x).children().closest("span").text().toLowerCase();
    /** @type {string} */
  ...
  function i(a, c, b) {
    ...
    $(".main-content").children().eq(c).addClass("section--is-active");
    $(".main-content .section").children().removeClass("section--next section--prev");
    if (a === b && 0 === c || 0 === a && c === b) {
      $(".main-content .section").children().removeClass("section--next section--prev");
    } else {
      if (c > a) {
        $(".main-content").children().eq(a).children().addClass("section--next");
      } else {
        $(".main-content").children().eq(a).children().addClass("section--prev");
      }
    }
    if (0 !== c && c !== b) {
  ...
  function _init() {
    /** @type {*} */
    var a = JSON.parse('{"home":"0","about":"1","skills":"2","contact":"4","github":"3"}');
    var r = a[location.hash.substr(1)] || 0;
    /** @type {!Array<string>} */
    var aKeys = Object.keys(a);
    var n = a[aKeys[aKeys.length - 1]];
    next(r);
    i(1, r, n);
  }
  /**
  ...
  $(".side-nav li, .outer-nav li").click(function() {
    if (!$(this).hasClass("is-active")) {
      var th = $(this);
      var _allTh = th.parent().find(".is-active");
      var val = th.parent().children().index(_allTh);
      var e = th.parent().children().index(th);
      /** @type {number} */
      var n = $(this).parent().children().length - 1;
      next(e);
      i(val, e, n);
    }
  });
  $(".cta").click(function() {
    var _allTh = $(".side-nav").find(".is-active");
    var val = $(".side-nav").children().index(_allTh);
    /** @type {number} */
    var n = $(".side-nav").children().length - 1;
    /** @type {number} */
    var p = n;
